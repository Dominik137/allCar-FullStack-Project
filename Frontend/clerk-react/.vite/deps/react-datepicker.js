...
var nr = (tr = function(t2) {
  ...
  var r2 = import_react4.default.useRef(), n = useFloating2(De({ open: !t2.hidePopper, whileElementsMounted: autoUpdate, placement: t2.popperPlacement, middleware: [flip2({ padding: 15 }), offset(10), arrow3({ element: r2 })].concat(xe(t2.popperModifiers)) }, t2.popperProps));
  return import_react4.default.createElement(tr, _e({}, t2, { popperProps: De(De({}, n), {}, { arrowRef: r2 }) }));
}).defaultProps = { popperModifiers: [], popperProps: {}, hidePopper: true }, rr);
var or = "react-datepicker-ignore-onclickoutside";
var ar = react_onclickoutside_es_default(Gt);
